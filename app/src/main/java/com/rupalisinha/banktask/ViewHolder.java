...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView mName, mPhonenumber, mBalance, mRupee, mRupeeslash, mName1, mName2, mDate, mTransc_status,mAccountNumber;
    ...
    public ViewHolder(@NonNull View itemView) {
        ...
        mAccountNumber=itemView.findViewById(R.id.accountnumber);
