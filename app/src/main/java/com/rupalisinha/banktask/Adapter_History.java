...
public class Adapter_History  extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.rupalisinha.banktask.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public Adapter_History(com.rupalisinha.banktask.HistoryList historyList, List<Model> modelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.transfer_history_data, parent, false);
